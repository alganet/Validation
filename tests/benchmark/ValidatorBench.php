...
class ValidatorBench
{
    ...
    #[Bench\ParamProviders(['provideStableValidatorInput'])]
    #[Bench\Iterations(10)]
    ...
    public function benchValidateStable(array $params): void
    {
        [$v, $input] = $params;
        $v->validate($input);
    }
    ...
    /** @param array<Validator, mixed> $params */
    #[Bench\ParamProviders(['provideUnstableValidatorInput'])]
    #[Bench\Iterations(10)]
    #[Bench\RetryThreshold(5)]
    #[Bench\Revs(5)]
    #[Bench\Warmup(2)]
    ...
    #[Bench\Assert('mode(variant.mem.real) < mode(baseline.mem.real) +/- 10%')]
    #[Bench\Assert('mode(variant.mem.final) < mode(baseline.mem.final) +/- 10%')]
    public function benchValidateUnstable(array $params): void
    {
