...
| IsoCodesBench            | countryCode       |                    | 5    | 10  | 3.099mb  | 5.617μs   | ±2.32%  |
| IsoCodesBench            | currencyCode      |                    | 5    | 10  | 2.965mb  | 5.643μs   | ±2.65%  |
| IsoCodesBench            | languageCode      |                    | 5    | 10  | 10.046mb | 5.800μs   | ±2.67%  |
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 39.798μs  | ±1.31%  |
...
| ValidatorBench           | evaluate          | DateTimeDiff       | 5    | 10  | 2.065mb  | 8.200μs   | ±1.47%  |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 28.903μs  | ±1.23%  |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.784μs   | ±2.75%  |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 27.427μs  | ±1.57%  |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 198.843μs | ±1.15%  |
...
| ValidatorBench           | evaluate          | KeySet             | 5    | 10  | 2.065mb  | 6.437μs   | ±2.71%  |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 196.654μs | ±1.30%  |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 43.098μs  | ±1.43%  |
...
| ValidatorBench           | evaluate          | Size               | 5    | 10  | 2.065mb  | 10.187μs  | ±2.22%  |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 50.870μs  | ±2.99%  |
...
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.820μs   | ±0.59%  |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.840μs   | ±1.55%  |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.730μs   | ±1.07%  |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.064mb  | 0.100μs   | ±0.00%  |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.064mb  | 0.260μs   | ±1.91%  |
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.625μs   | ±1.17%  |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.221μs   | ±0.79%  |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.322μs   | ±3.14%  |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.855μs   | ±1.18%  |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 4.827μs   | ±3.85%  |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 6.092μs   | ±6.06%  |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.441μs   | ±2.53%  |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.836μs   | ±10.41% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.096μs   | ±6.96%  |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 5.721μs   | ±5.73%  |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.758μs  | ±2.33%  |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 22.231μs  | ±0.81%  |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 77.436μs  | ±0.69%  |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 180.037μs | ±0.82%  |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.684μs   | ±5.05%  |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 6.741μs   | ±2.89%  |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 6.685μs   | ±3.85%  |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 6.703μs   | ±3.18%  |
