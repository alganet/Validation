...
|--------------------------|-------------------|--------------------|------|-----|----------|-----------|---------|
| IsoCodesBench            | subdivisionCode   |                    | 5    | 10  | 8.009mb  | 8.349μs   | ±2.60%  |
| IsoCodesBench            | countryCode       |                    | 5    | 10  | 3.099mb  | 6.200μs   | ±2.50%  |
| IsoCodesBench            | currencyCode      |                    | 5    | 10  | 2.965mb  | 6.000μs   | ±1.34%  |
| IsoCodesBench            | languageCode      |                    | 5    | 10  | 10.046mb | 8.189μs   | ±1.57%  |
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 42.627μs  | ±1.83%  |
...
| ValidatorBench           | evaluate          | Date               | 5    | 10  | 2.064mb  | 7.043μs   | ±2.13%  |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 29.970μs  | ±1.69%  |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.600μs   | ±1.63%  |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 27.734μs  | ±2.30%  |
...
| ValidatorBench           | evaluate          | Hetu               | 5    | 10  | 2.064mb  | 7.184μs   | ±2.60%  |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 186.797μs | ±2.30%  |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 189.607μs | ±1.42%  |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 44.079μs  | ±2.90%  |
...
| ValidatorBench           | evaluate          | Size               | 5    | 10  | 2.065mb  | 10.202μs  | ±2.17%  |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 51.183μs  | ±1.89%  |
...
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.862μs   | ±1.55%  |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.911μs   | ±1.04%  |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.786μs   | ±1.28%  |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.064mb  | 0.100μs   | ±0.00%  |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.064mb  | 0.300μs   | ±1.79%  |
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.842μs   | ±7.70%  |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.336μs   | ±3.88%  |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.444μs   | ±0.67%  |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.972μs   | ±5.44%  |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 5.370μs   | ±5.13%  |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 5.975μs   | ±3.75%  |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.741μs   | ±2.35%  |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.966μs   | ±8.84%  |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.347μs   | ±12.43% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 6.302μs   | ±3.48%  |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.956μs  | ±1.84%  |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 22.534μs  | ±1.29%  |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 78.767μs  | ±0.67%  |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 179.436μs | ±0.35%  |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 7.178μs   | ±16.19% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 6.868μs   | ±1.81%  |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 6.930μs   | ±2.10%  |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 7.453μs   | ±6.82%  |
