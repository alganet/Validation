...
|--------------------------|-------------------|--------------------|------|-----|----------|-----------|--------|
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.863μs   | ±1.06% |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.901μs   | ±1.23% |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.740μs   | ±1.93% |
...
| ValidatorBench           | evaluate          | DateTimeDiff       | 5    | 10  | 2.065mb  | 8.369μs   | ±2.13% |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 30.690μs  | ±2.07% |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 7.184μs   | ±2.60% |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 28.653μs  | ±2.01% |
...
| ValidatorBench           | evaluate          | Formatted          | 5    | 10  | 2.065mb  | 5.800μs   | ±1.60% |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 175.816μs | ±1.97% |
...
| ValidatorBench           | evaluate          | KeySet             | 5    | 10  | 2.065mb  | 6.800μs   | ±1.34% |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 169.112μs | ±2.51% |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 46.296μs  | ±1.34% |
...
| ValidatorBench           | evaluate          | Size               | 5    | 10  | 2.065mb  | 10.468μs  | ±2.18% |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 53.195μs  | ±1.27% |
| ValidatorBench           | evaluate          | Uuid               | 5    | 10  | 2.880mb  | 7.613μs   | ±2.78% |
...
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.936μs   | ±4.71% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.499μs   | ±0.63% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.572μs   | ±5.24% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 4.042μs   | ±6.93% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 4.954μs   | ±2.51% |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 6.082μs   | ±6.54% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.671μs   | ±0.58% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.751μs   | ±3.22% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.231μs   | ±0.52% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 6.523μs   | ±4.76% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 13.254μs  | ±2.26% |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 23.677μs  | ±1.02% |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 79.541μs  | ±1.19% |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 190.708μs | ±0.31% |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.903μs   | ±3.35% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 7.590μs   | ±5.37% |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 6.969μs   | ±3.42% |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 6.901μs   | ±4.32% |
...
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.165mb  | 41.238μs  | ±1.48% |
