...
|--------------------------|-------------------|--------------------|------|-----|----------|-----------|--------|
| ValidatorBench           | evaluate          | After              | 5    | 10  | 2.064mb  | 5.400μs   | ±1.66% |
| ValidatorBench           | evaluate          | All                | 5    | 10  | 2.064mb  | 6.101μs   | ±3.36% |
...
| ValidatorBench           | evaluate          | CreditCard         | 5    | 10  | 2.064mb  | 5.604μs   | ±2.13% |
...
| ValidatorBench           | evaluate          | DateTimeDiff       | 5    | 10  | 2.065mb  | 8.193μs   | ±1.92% |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.371mb  | 30.033μs  | ±2.24% |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.653μs   | ±2.45% |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 27.868μs  | ±1.64% |
...
| ValidatorBench           | evaluate          | Formatted          | 5    | 10  | 2.064mb  | 5.200μs   | ±0.00% |
...
| ValidatorBench           | evaluate          | Hetu               | 5    | 10  | 2.064mb  | 7.051μs   | ±3.17% |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 232.396μs | ±2.86% |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 226.496μs | ±1.78% |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 43.654μs  | ±1.51% |
...
| ValidatorBench           | evaluate          | Size               | 5    | 10  | 2.065mb  | 10.017μs  | ±1.31% |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 51.381μs  | ±0.97% |
| ValidatorBench           | evaluate          | Uuid               | 5    | 10  | 2.880mb  | 7.346μs   | ±2.90% |
...
| IsoCodesBench            | subdivisionCode   |                    | 5    | 10  | 8.009mb  | 7.101μs   | ±2.27% |
...
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 39.992μs  | ±1.91% |
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.814μs   | ±1.55% |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.820μs   | ±0.78% |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.730μs   | ±1.19% |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.064mb  | 0.100μs   | ±0.00% |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.064mb  | 0.280μs   | ±2.51% |
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.724mb  | 4.747μs   | ±0.86% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.226μs   | ±2.84% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.723mb  | 4.417μs   | ±0.36% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.858μs   | ±0.53% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 4.793μs   | ±3.69% |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 5.892μs   | ±0.58% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.550μs   | ±5.98% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.767mb  | 5.631μs   | ±0.66% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.047μs   | ±3.75% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 5.809μs   | ±4.69% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.790μs  | ±2.32% |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 22.078μs  | ±0.68% |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 76.997μs  | ±0.90% |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 177.487μs | ±0.34% |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.675μs   | ±2.31% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 6.708μs   | ±2.14% |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 6.731μs   | ±2.47% |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 7.022μs   | ±3.25% |
