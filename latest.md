...
| IsoCodesBench            | languageCode      |                    | 5    | 10  | 10.046mb | 5.747μs   | ±2.96% |
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 40.249μs  | ±1.52% |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 28.853μs  | ±0.68% |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.807μs   | ±2.05% |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 27.276μs  | ±2.52% |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 201.071μs | ±2.21% |
...
| ValidatorBench           | evaluate          | KeySet             | 5    | 10  | 2.065mb  | 6.798μs   | ±1.49% |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 196.636μs | ±2.52% |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 43.393μs  | ±3.10% |
...
| ValidatorBench           | evaluate          | Size               | 5    | 10  | 2.065mb  | 10.230μs  | ±1.75% |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 50.203μs  | ±1.26% |
| ValidatorBench           | evaluate          | Uuid               | 5    | 10  | 2.880mb  | 7.801μs   | ±2.22% |
...
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.824μs   | ±1.79% |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.831μs   | ±0.80% |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.733μs   | ±1.25% |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.064mb  | 0.100μs   | ±0.00% |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.064mb  | 0.250μs   | ±1.59% |
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.671μs   | ±7.99% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.325μs   | ±6.55% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.319μs   | ±0.23% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.822μs   | ±6.12% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 4.761μs   | ±5.10% |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 5.936μs   | ±2.43% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.448μs   | ±5.65% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.927μs   | ±2.91% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.080μs   | ±3.53% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 5.761μs   | ±3.42% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.441μs  | ±2.41% |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 22.246μs  | ±3.76% |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 77.321μs  | ±0.61% |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 179.732μs | ±0.33% |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.686μs   | ±5.45% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 6.752μs   | ±5.75% |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 6.686μs   | ±2.84% |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 6.649μs   | ±3.09% |
