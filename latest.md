...
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 40.871μs  | ±1.97% |
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.862μs   | ±1.04% |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.878μs   | ±0.85% |
...
| ValidatorBench           | evaluate          | All                | 5    | 10  | 2.064mb  | 6.455μs   | ±2.81% |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 30.552μs  | ±2.75% |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 7.000μs   | ±1.53% |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 28.701μs  | ±1.68% |
...
| ValidatorBench           | evaluate          | Hetu               | 5    | 10  | 2.064mb  | 6.807μs   | ±2.28% |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 177.288μs | ±2.19% |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 169.923μs | ±2.75% |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 43.198μs  | ±0.69% |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 57.463μs  | ±2.71% |
...
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.764μs   | ±5.33% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.276μs   | ±4.35% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.425μs   | ±6.31% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.916μs   | ±5.24% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 4.776μs   | ±5.62% |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 6.466μs   | ±4.40% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.686μs   | ±8.02% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.665μs   | ±7.30% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.192μs   | ±2.87% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 5.934μs   | ±4.06% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 13.025μs  | ±3.99% |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 23.152μs  | ±1.61% |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 78.140μs  | ±1.46% |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 185.027μs | ±0.44% |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.886μs   | ±6.48% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 6.947μs   | ±2.85% |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 7.303μs   | ±3.68% |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 7.455μs   | ±4.93% |
