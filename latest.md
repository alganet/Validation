...
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 39.932μs  | ±1.39%  |
...
| ValidatorBench           | evaluate          | Date               | 5    | 10  | 2.064mb  | 6.600μs   | ±0.91%  |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 29.509μs  | ±2.02%  |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.701μs   | ±2.41%  |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 27.570μs  | ±0.95%  |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 175.395μs | ±2.06%  |
...
| ValidatorBench           | evaluate          | KeySet             | 5    | 10  | 2.065mb  | 6.795μs   | ±2.41%  |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 183.736μs | ±2.82%  |
...
| ValidatorBench           | evaluate          | NfeAccessKey       | 5    | 10  | 2.064mb  | 5.800μs   | ±1.03%  |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 43.142μs  | ±0.64%  |
...
| ValidatorBench           | evaluate          | Size               | 5    | 10  | 2.065mb  | 10.190μs  | ±1.52%  |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 50.965μs  | ±2.56%  |
| ValidatorBench           | evaluate          | Uuid               | 5    | 10  | 2.880mb  | 7.593μs   | ±1.85%  |
...
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.821μs   | ±1.56%  |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.823μs   | ±1.18%  |
...
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.652μs   | ±3.22%  |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.169μs   | ±2.28%  |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.317μs   | ±3.07%  |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.805μs   | ±0.84%  |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 4.742μs   | ±4.36%  |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 5.846μs   | ±3.01%  |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.390μs   | ±2.82%  |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.885μs   | ±3.66%  |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.068μs   | ±0.69%  |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 5.864μs   | ±13.30% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.682μs  | ±2.94%  |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 22.040μs  | ±1.58%  |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 78.006μs  | ±1.09%  |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 176.217μs | ±0.72%  |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.652μs   | ±3.28%  |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 6.706μs   | ±3.85%  |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 6.671μs   | ±2.49%  |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 6.709μs   | ±3.51%  |
