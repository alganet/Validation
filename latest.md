...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 28.778μs  | ±1.70% |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.873μs   | ±3.57% |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 26.764μs  | ±1.38% |
...
| ValidatorBench           | evaluate          | Hetu               | 5    | 10  | 2.064mb  | 6.800μs   | ±1.58% |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 259.973μs | ±1.87% |
...
| ValidatorBench           | evaluate          | KeySet             | 5    | 10  | 2.065mb  | 6.614μs   | ±2.38% |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 263.195μs | ±3.27% |
...
| ValidatorBench           | evaluate          | OneOf              | 5    | 10  | 2.064mb  | 4.600μs   | ±1.94% |
| ValidatorBench           | evaluate          | Pesel              | 5    | 10  | 2.064mb  | 2.000μs   | ±0.00% |
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 43.053μs  | ±1.54% |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 49.507μs  | ±2.22% |
...
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 39.855μs  | ±1.23% |
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.821μs   | ±0.97% |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.821μs   | ±0.94% |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.746μs   | ±1.61% |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.064mb  | 0.100μs   | ±0.00% |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.064mb  | 0.250μs   | ±1.93% |
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.624μs   | ±0.50% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.188μs   | ±3.52% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.323μs   | ±0.45% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.801μs   | ±0.26% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 4.712μs   | ±7.93% |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 5.836μs   | ±3.69% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.434μs   | ±2.43% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.576μs   | ±3.92% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.442μs   | ±4.40% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 5.783μs   | ±3.49% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.667μs  | ±1.38% |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 22.123μs  | ±1.16% |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 77.916μs  | ±1.34% |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 178.632μs | ±2.26% |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.591μs   | ±1.42% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 6.663μs   | ±2.90% |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 6.641μs   | ±0.55% |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 6.648μs   | ±3.06% |
