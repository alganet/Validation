...
|--------------------------|-------------------|--------------------|------|-----|----------|-----------|---------|
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.917μs   | ±1.00%  |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.377μs   | ±4.25%  |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.465μs   | ±22.60% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.921μs   | ±5.42%  |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 4.922μs   | ±3.05%  |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 6.346μs   | ±15.58% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.606μs   | ±1.22%  |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.671μs   | ±4.89%  |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.680μs   | ±3.91%  |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 5.892μs   | ±3.41%  |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.878μs  | ±7.03%  |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 22.569μs  | ±0.61%  |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 79.875μs  | ±0.87%  |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 181.235μs | ±0.70%  |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.887μs   | ±3.81%  |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 6.858μs   | ±3.29%  |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 6.927μs   | ±3.99%  |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 6.818μs   | ±6.62%  |
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.837μs   | ±1.30%  |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.868μs   | ±1.21%  |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.745μs   | ±1.26%  |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.064mb  | 0.100μs   | ±0.00%  |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.064mb  | 0.297μs   | ±2.85%  |
...
| ValidatorBench           | evaluate          | Date               | 5    | 10  | 2.064mb  | 6.600μs   | ±1.63%  |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 29.643μs  | ±1.22%  |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.617μs   | ±1.97%  |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 27.773μs  | ±2.40%  |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 206.307μs | ±2.46%  |
...
| ValidatorBench           | evaluate          | KeySet             | 5    | 10  | 2.065mb  | 6.616μs   | ±2.78%  |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 202.045μs | ±2.13%  |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 44.800μs  | ±1.92%  |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 52.401μs  | ±1.71%  |
| ValidatorBench           | evaluate          | Uuid               | 5    | 10  | 2.880mb  | 8.147μs   | ±2.07%  |
...
| IsoCodesBench            | subdivisionCode   |                    | 5    | 10  | 8.009mb  | 8.207μs   | ±1.89%  |
| IsoCodesBench            | countryCode       |                    | 5    | 10  | 3.099mb  | 6.000μs   | ±1.32%  |
| IsoCodesBench            | currencyCode      |                    | 5    | 10  | 2.965mb  | 5.814μs   | ±2.70%  |
| IsoCodesBench            | languageCode      |                    | 5    | 10  | 10.046mb | 7.190μs   | ±2.55%  |
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 42.171μs  | ±1.52%  |
