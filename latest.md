...
|--------------------------|-------------------|--------------------|------|-----|----------|-----------|--------|
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.869μs   | ±2.54% |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.880μs   | ±1.34% |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.788μs   | ±1.89% |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.064mb  | 0.100μs   | ±0.00% |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.064mb  | 0.290μs   | ±1.56% |
| IsoCodesBench            | subdivisionCode   |                    | 5    | 10  | 8.009mb  | 6.804μs   | ±1.75% |
| IsoCodesBench            | countryCode       |                    | 5    | 10  | 3.099mb  | 5.807μs   | ±2.41% |
| IsoCodesBench            | currencyCode      |                    | 5    | 10  | 2.965mb  | 5.800μs   | ±1.56% |
| IsoCodesBench            | languageCode      |                    | 5    | 10  | 10.046mb | 5.976μs   | ±2.99% |
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 40.151μs  | ±2.27% |
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.766μs   | ±5.57% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.772μs   | ±3.84% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.465μs   | ±4.78% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.936μs   | ±5.03% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 5.314μs   | ±4.93% |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 5.961μs   | ±3.96% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.515μs   | ±2.87% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.658μs   | ±0.94% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.261μs   | ±7.55% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 6.568μs   | ±5.03% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.889μs  | ±1.77% |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 22.510μs  | ±1.12% |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 78.842μs  | ±0.41% |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 180.474μs | ±1.06% |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.731μs   | ±1.10% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 6.805μs   | ±2.90% |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 7.542μs   | ±5.41% |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 6.813μs   | ±1.24% |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 29.771μs  | ±1.13% |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.800μs   | ±1.18% |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 27.476μs  | ±1.76% |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 187.099μs | ±1.53% |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 190.515μs | ±2.02% |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 43.793μs  | ±1.84% |
...
| ValidatorBench           | evaluate          | Size               | 5    | 10  | 2.065mb  | 10.004μs  | ±1.20% |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 51.331μs  | ±2.11% |
| ValidatorBench           | evaluate          | Uuid               | 5    | 10  | 2.880mb  | 7.381μs   | ±2.98% |
