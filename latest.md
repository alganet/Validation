...
|--------------------------|-------------------|--------------------|------|-----|----------|-----------|--------|
| IsoCodesBench            | subdivisionCode   |                    | 5    | 10  | 8.009mb  | 7.200μs   | ±2.07% |
| IsoCodesBench            | countryCode       |                    | 5    | 10  | 3.099mb  | 5.999μs   | ±1.66% |
| IsoCodesBench            | currencyCode      |                    | 5    | 10  | 2.965mb  | 6.000μs   | ±1.00% |
| IsoCodesBench            | languageCode      |                    | 5    | 10  | 10.046mb | 6.016μs   | ±3.05% |
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 45.192μs  | ±1.91% |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 29.029μs  | ±1.90% |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.607μs   | ±2.11% |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 27.532μs  | ±1.45% |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 201.333μs | ±1.25% |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 204.743μs | ±2.43% |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 43.757μs  | ±1.89% |
...
| ValidatorBench           | evaluate          | Time               | 5    | 10  | 2.064mb  | 4.800μs   | ±1.89% |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 50.998μs  | ±1.83% |
| ValidatorBench           | evaluate          | Uuid               | 5    | 10  | 2.880mb  | 7.760μs   | ±3.03% |
...
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.878μs   | ±1.75% |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.883μs   | ±1.82% |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.752μs   | ±2.72% |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.064mb  | 0.100μs   | ±0.00% |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.064mb  | 0.300μs   | ±2.33% |
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.791μs   | ±5.00% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.366μs   | ±3.25% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.460μs   | ±0.63% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.974μs   | ±1.04% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 5.091μs   | ±8.31% |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 6.012μs   | ±6.21% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.567μs   | ±4.61% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.658μs   | ±1.17% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.130μs   | ±0.71% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 5.901μs   | ±2.45% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.864μs  | ±4.24% |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 22.358μs  | ±0.88% |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 78.630μs  | ±1.14% |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 178.349μs | ±0.54% |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.942μs   | ±9.21% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 7.181μs   | ±1.93% |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 6.823μs   | ±2.84% |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 6.826μs   | ±3.46% |
