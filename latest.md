...
| IsoCodesBench            | currencyCode      |                    | 5    | 10  | 2.965mb  | 5.783μs   | ±2.34% |
| IsoCodesBench            | languageCode      |                    | 5    | 10  | 10.046mb | 5.796μs   | ±2.08% |
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 39.885μs  | ±1.86% |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 28.957μs  | ±2.13% |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.800μs   | ±1.17% |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 27.429μs  | ±2.48% |
...
| ValidatorBench           | evaluate          | ShortCircuit       | 5    | 10  | 2.064mb  | 2.500μs   | ±4.00% |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 178.250μs | ±2.19% |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 176.680μs | ±2.32% |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 43.261μs  | ±1.36% |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 50.975μs  | ±2.50% |
| ValidatorBench           | evaluate          | Uuid               | 5    | 10  | 2.880mb  | 7.809μs   | ±2.14% |
...
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.845μs   | ±1.55% |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.731μs   | ±1.46% |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.064mb  | 0.100μs   | ±0.00% |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.064mb  | 0.250μs   | ±1.59% |
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.702μs   | ±3.12% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.595μs   | ±3.97% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.361μs   | ±2.99% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.829μs   | ±1.61% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 4.781μs   | ±1.43% |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 5.916μs   | ±3.27% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.475μs   | ±7.25% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.578μs   | ±6.62% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.077μs   | ±5.57% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 5.771μs   | ±4.05% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.754μs  | ±2.98% |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 22.119μs  | ±1.74% |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 77.744μs  | ±0.71% |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 179.126μs | ±0.51% |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 6.814μs   | ±3.12% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 7.070μs   | ±2.72% |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 6.749μs   | ±4.06% |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 6.947μs   | ±3.71% |
